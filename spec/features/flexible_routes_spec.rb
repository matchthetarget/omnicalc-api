...
describe "/flexible/square/[ANY INTEGER]" do
  it "should display the Integer from the URL." do
    visit "/flexible/square/3"
...
describe "/flexible/square/[ANY INTEGER]" do
  it "should display the square of the Integer from the URL." do
    visit "/flexible/square/3"
...
describe "/flexible/square/[ANY INTEGER]" do
  it "should display the Integer and the square of the Integer in JSON." do
...
describe "/flexible/square_root/[ANY INTEGER]" do
  it "should display the square root of the Integer from the URL." do
...
describe "/flexible/square_root/[ANY INTEGER]" do
  it "should display the Integer and the square of the Integer in JSON." do
    ...
    json_result = { :number => 1764, :square_root => 42 }.to_json
...
describe "/flexible/random/[MIN]/[MAX]" do
  it "should display the Min and Max Integers from the URL." do
...
describe "/flexible/random/[MIN]/[MAX]" do
  it "should display a random number between the min and max from the URL." do
    visit "/flexible/random/50/100"
...
describe "/flexible/random/[MIN]/[MAX]" do
  it "should display the Integer and the square of the Integer in JSON."
end
